...
#define AI_FNN_MODEL_NAME          "fnn"

#define AI_FNN_IN_NUM       (1)
#define AI_FNN_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 768, 1, NULL)
#define AI_FNN_IN_1_SIZE \
  (1 * 1 * 768)

#define AI_FNN_OUT_NUM      (1)
#define AI_FNN_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL)
#define AI_FNN_OUT_1_SIZE \
  (1 * 1 * 1)
 ...
 * @ref ai_fnn_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_FNN_*
 * defines into file @ref fnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
