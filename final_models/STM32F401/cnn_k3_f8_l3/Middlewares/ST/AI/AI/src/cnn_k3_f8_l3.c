...
#define AI_NET_OBJ_INSTANCE g_cnn_k3_f8_l3
 
#undef AI_CNN_K3_F8_L3_MODEL_SIGNATURE
#define AI_CNN_K3_F8_L3_MODEL_SIGNATURE     "68e6523016eb905145563906e1e5b8ea"
...
#define AI_TOOLS_DATE_TIME   "Wed Aug 21 16:08:21 2019"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_CNN_K3_F8_L3_N_BATCHES
#define AI_CNN_K3_F8_L3_N_BATCHES         (1)
...
AI_DECLARE_STATIC
ai_bool cnn_k3_f8_l3_configure_activations(
...
AI_DECLARE_STATIC
ai_bool cnn_k3_f8_l3_configure_weights(
...
AI_API_ENTRY
ai_bool ai_cnn_k3_f8_l3_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_CNN_K3_F8_L3_MODEL_NAME,
      .model_signature   = AI_CNN_K3_F8_L3_MODEL_SIGNATURE,
      ...
      .n_macc            = 656921,
      .n_inputs          = AI_CNN_K3_F8_L3_IN_NUM,
      .inputs            = AI_BUFFER_OBJ_INIT(
                              ...
                              1,
                              1, NULL),
      .n_outputs         = AI_CNN_K3_F8_L3_OUT_NUM,
...
AI_API_ENTRY
ai_error ai_cnn_k3_f8_l3_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_cnn_k3_f8_l3_create(
...
AI_API_ENTRY
ai_handle ai_cnn_k3_f8_l3_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_cnn_k3_f8_l3_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= cnn_k3_f8_l3_configure_weights(net_ctx, &params->params);
  ok &= cnn_k3_f8_l3_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_cnn_k3_f8_l3_forward(ai_handle network, const ai_buffer* input)
{
