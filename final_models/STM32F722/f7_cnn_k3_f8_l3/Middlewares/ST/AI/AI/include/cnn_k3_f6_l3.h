...
#ifndef __AI_CNN_K3_F6_L3_H__
#define __AI_CNN_K3_F6_L3_H__
#pragma once

#include "ai_platform.h"

#define AI_CNN_K3_F6_L3_MODEL_NAME          "cnn_k3_f6_l3"

#define AI_CNN_K3_F6_L3_IN_NUM       (1)
#define AI_CNN_K3_F6_L3_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 24, 32, 1, 1, NULL)
#define AI_CNN_K3_F6_L3_IN_1_SIZE \
  (24 * 32 * 1)

#define AI_CNN_K3_F6_L3_OUT_NUM      (1)
#define AI_CNN_K3_F6_L3_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL)
#define AI_CNN_K3_F6_L3_OUT_1_SIZE \
  (1 * 1 * 1)
 ...
 * @ref ai_cnn_k3_f6_l3_create. Both the activations memory buffer 
 ...
 * using @ref ai_cnn_k3_f6_l3_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_CNN_K3_F6_L3_*
 * defines into file @ref cnn_k3_f6_l3.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cnn_k3_f6_l3_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_CNN_K3_F6_L3_H__*/
