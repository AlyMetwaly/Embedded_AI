...
#ifndef __AI_FNN_L1_N512_H__
#define __AI_FNN_L1_N512_H__
#pragma once

#include "ai_platform.h"

#define AI_FNN_L1_N512_MODEL_NAME          "fnn_l1_n512"

#define AI_FNN_L1_N512_IN_NUM       (1)
#define AI_FNN_L1_N512_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 768, 1, NULL)
#define AI_FNN_L1_N512_IN_1_SIZE \
  (1 * 1 * 768)

#define AI_FNN_L1_N512_OUT_NUM      (1)
#define AI_FNN_L1_N512_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL)
#define AI_FNN_L1_N512_OUT_1_SIZE \
  (1 * 1 * 1)
 ...
 * @ref ai_fnn_l1_n512_create. Both the activations memory buffer 
 ...
 * using @ref ai_fnn_l1_n512_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_FNN_L1_N512_*
 * defines into file @ref fnn_l1_n512.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_fnn_l1_n512_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_FNN_L1_N512_H__*/
