...
#ifndef __AI_GRU_L1_N12_H__
#define __AI_GRU_L1_N12_H__
#pragma once

#include "ai_platform.h"

#define AI_GRU_L1_N12_MODEL_NAME          "gru_l1_n12"

#define AI_GRU_L1_N12_IN_NUM       (1)
#define AI_GRU_L1_N12_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 20, 1, 768, 1, NULL)
#define AI_GRU_L1_N12_IN_1_SIZE \
  (20 * 1 * 768)

#define AI_GRU_L1_N12_OUT_NUM      (1)
#define AI_GRU_L1_N12_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL)
#define AI_GRU_L1_N12_OUT_1_SIZE \
  (1 * 1 * 1)
 ...
 * @ref ai_gru_l1_n12_create. Both the activations memory buffer 
 ...
 * using @ref ai_gru_l1_n12_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_GRU_L1_N12_*
 * defines into file @ref gru_l1_n12.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_gru_l1_n12_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_GRU_L1_N12_H__*/
